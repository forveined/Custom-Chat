--[=[
	Cryptography library: SHA512/256
	...
	Example usage:
		...
		--------Usage Case 1--------
		local Result = SHA512_256(Message)
		
		--------Usage Case 2--------
		local OptionalSalt = buffer.fromstring("Salty")
		local Result = SHA512_256(Message, OptionalSalt)
--]=]
...
do
	local INITIAL_FRONT = {0x22312194, 0x9f555fa3, 0x2393b86b, 0x96387719, 0x96283ee2, 0xbe5e1e25, 0x2b0199fc, 0x0eb72ddC}
	local INITIAL_BACK = {0xfc2bf72c, 0xc84c64c2, 0x6f53b151, 0x5940eabd, 0xa88effe3, 0x53863992, 0x2c85b8aa, 0x81c52ca2}
...
local function SHA512_256(Message: buffer, Salt: buffer?): (string, buffer)
	...
	return string.format(FORMAT_STRING, H1F, H1B, H2F, H2B, H3F, H3B, H4F, H4B), Digest
end
