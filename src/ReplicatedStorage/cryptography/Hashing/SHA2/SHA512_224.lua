--[=[
	Cryptography library: SHA512/224
	...
	Example usage:
		...
		--------Usage Case 1--------
		local Result = SHA512_224(Message)
		
		--------Usage Case 2--------
		local OptionalSalt = buffer.fromstring("Salty")
		local Result = SHA512_224(Message, OptionalSalt)
--]=]
...
do
	local INITIAL_FRONT = {0x8c3d37c8, 0x73e19966, 0x1dfab7ae, 0x679dd514, 0x0f6d2b69, 0x77e36f73, 0x3f9d85a8, 0x1112e6ad}
	local INITIAL_BACK = {0x19544da2, 0x89dcd4d6, 0x32ff9c82, 0x582f9fcf, 0x7bd44da8, 0x04C48942, 0x6a1d36C8, 0x91d692a1}
...
local function SHA512_224(Message: buffer, Salt: buffer?): (string, buffer)
	...
	local H1B, H2B, H3B = buffer.readu32(Digest, 4), buffer.readu32(Digest, 12), buffer.readu32(Digest, 20)

	return string.format(FORMAT_STRING, H1F, H1B, H2F, H2B, H3F, H3B, H4F), Digest
end
